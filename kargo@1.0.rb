...
class KargoAT10 < Formula
    ...
    on_macos do
      if Hardware::CPU.intel?
        url "https://github.com/akuity/kargo/releases/download/v1.0.3/kargo-darwin-amd64"
        sha256 "131b1e0e4154a3253b4f0b39d572ddfda21ed14d0c505ee5d013f509af35479d"
      elsif Hardware::CPU.arm?
        url "https://github.com/akuity/kargo/releases/download/v1.0.3/kargo-darwin-arm64"
    ...
    on_linux do
      if Hardware::CPU.intel?
        url "https://github.com/akuity/kargo/releases/download/v1.0.3/kargo-linux-amd64"
        sha256 "17ed084a0354456883a47bedb38b7bf9f4c60b93c9fd78fa52e7ab18695bf2d0"
      elsif Hardware::CPU.arm?
        url "https://github.com/akuity/kargo/releases/download/v1.0.3/kargo-linux-arm64"
